 ...
 *
 * @param[in]       recorder context
 * @param[out]      video encoder parameters @see mr_video_encoder_params_ex_t
 *
 * @return =0 on success, negative HB_MEDIA_ERROR in case of failure
 * @see media_recorder_context_t
 * @see mr_video_encoder_params_ex_t
 */
 ...
 *
 * @param[in]       recorder context
 * @param[in]       video encoder parameters @see mr_video_encoder_params_ex_t
 *
 * @return =0 on success, negative HB_MEDIA_ERROR in case of failure
 * @see media_recorder_context_t
 * @see mr_video_encoder_params_ex_t
