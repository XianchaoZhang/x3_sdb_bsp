...
# @Last Modified time: 2022-04-17 16:12:05
...
function build_miniboot_image()
{
    ...
    # 获取 miniboot 分区的结束block位置，并生成一个全0的miniboot.img，之后再把各分区的image填充到这个miniboot.img中
    ...
    # 然后mbr再覆盖miniboot.img最前头的512个字节
    # mbr
    ...
    # 填充miniboot中包含的spl、ddr、bl31、efuse等内容
