...
export HR_BSP_VERSION="x3j3_lnx_db_$(date '+%Y%m%d') quickboot"
...
export HR_GPT_CONF_FILENAME="emmc_yocto_golden_quickboot_gpt.conf"
...
#快速启动系统配置
export HR_QUICKBOOT="true"
export HR_ENABLE_FAST_SPL="true"
