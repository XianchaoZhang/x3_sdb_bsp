...
extern int g_taskbufsize;
extern int g_calib;
extern int g_temperMode;
extern int g_frame_rate;
extern int g_vps_frame_depth;
extern int g_use_input;
extern int g_intra_qp;
extern int g_inter_qp;

extern int compare;
extern int cmp_param[6];
typedef enum HB_MIPI_SNS_TYPE_E
{
	...
	SIF_TEST_PATTERN_12M_RAW12,  // 11
	SIF_TEST_PATTERN0_2160P,   // 12
	FEED_BACK_RAW12_1952P,    // 13
	SIF_TEST_PATTERN_YUV_720P,    // 14
	S5KGM1SP_30FPS_4000x3000_RAW10,   // 15
