...
typedef struct vio_cfg_s {
    ...
    /* 3. chn config */
     ...
     int crop_en[MAX_GRP_NUM][MAX_CHN_NUM];
     int crop_width[MAX_GRP_NUM][MAX_CHN_NUM];
     int crop_height[MAX_GRP_NUM][MAX_CHN_NUM];
     int crop_x[MAX_GRP_NUM][MAX_CHN_NUM];
     int crop_y[MAX_GRP_NUM][MAX_CHN_NUM];
