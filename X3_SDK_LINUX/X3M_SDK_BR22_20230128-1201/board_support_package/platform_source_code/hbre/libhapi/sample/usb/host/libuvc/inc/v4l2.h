 ...
 */
NATIVE_ATTR_ struct v4l2_device *v4l2_open(const char *devname);
 ...
 */
NATIVE_ATTR_ int v4l2_get_format(struct v4l2_device *dev, struct v4l2_pix_format *format);

/*
 * v4l2_set_format - Set the pixel format
 * @dev: Device instance
 * @format: v4l2 format structure to be set
 *
 * Set the v4l2 format and frame size stored in @format. The device can modify
 * the requested format and size, in which case the @format structure will be
 * updated to reflect the modified settings.
 *
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_set_format(struct v4l2_device *dev, struct v4l2_format *fmt);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_set_frame_rate(struct v4l2_device *dev, unsigned int fps);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_get_crop(struct v4l2_device *dev, struct v4l2_rect *rect);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_set_crop(struct v4l2_device *dev, struct v4l2_rect *rect);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_alloc_buffers(struct v4l2_device *dev, enum v4l2_memory memtype,
		       unsigned int nbufs);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_free_buffers(struct v4l2_device *dev);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_export_buffers(struct v4l2_device *dev);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_import_buffers(struct v4l2_device *dev,
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_mmap_buffers(struct v4l2_device *dev);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_queue_buffer(struct v4l2_device *dev, struct video_buffer *buffer);
 ...
 */
NATIVE_ATTR_ int v4l2_dequeue_buffer(struct v4l2_device *dev, struct video_buffer *buffer);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_stream_on(struct v4l2_device *dev);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_stream_off(struct v4l2_device *dev);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_get_control(struct v4l2_device *dev, unsigned int id, int32_t *value);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_set_control(struct v4l2_device *dev, unsigned int id, int32_t *value);
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_get_controls(struct v4l2_device *dev, unsigned int count,
 ...
 * Return 0 on success or a negative error code on failure.
 */
NATIVE_ATTR_ int v4l2_set_controls(struct v4l2_device *dev, unsigned int count,
		      struct v4l2_ext_control *ctrls);
