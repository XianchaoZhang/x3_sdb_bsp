...
tuning_tool -C "./hb_x3player.json" -v "./sdb_gc4663_raw_10bit_2560x1440_online_Pipeline.json" -H "/etc/tuning_tool/dump_yuv.json"  -r 100000 -c 0 -p 1 -t 1 -l 4 -m 0 -f 0 -g 1 -D 0