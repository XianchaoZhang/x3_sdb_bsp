...
#tuning_tool -C "./hb_x3player.json" -v "./sdb_imx477_raw_12bit_1920x1080_offline_Pipeline.json" -H "/etc/tuning_tool/dump_raw.json"  -r 100000 -c 0 -p 1 -t 1 -l 4 -m 0 -f 0 -g 0 -D 0
tuning_tool -C "./hb_x3player.json" -v "./sdb_imx477_raw_12bit_4000x3000_offline_Pipeline.json" -H "/etc/tuning_tool/dump_raw.json"  -r 100000 -c 1 -p 1 -t 1 -l 4 -m 0 -f 0 -g 0 -D 0 -S 1
