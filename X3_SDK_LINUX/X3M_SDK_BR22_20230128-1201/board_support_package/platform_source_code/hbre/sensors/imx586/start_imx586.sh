...
sleep 0.5
set -ex
tuning_tool -C "./hb_x3player.json" -v "./sdb_imx586_raw_10bit_3840x2160_offline_Pipeline.json" -H "/etc/tuning_tool/dump_raw.json"  -r 100000 -c 0 -p 1 -t 1 -l 4 -m 0 -f 0 -g 1 -D 0
