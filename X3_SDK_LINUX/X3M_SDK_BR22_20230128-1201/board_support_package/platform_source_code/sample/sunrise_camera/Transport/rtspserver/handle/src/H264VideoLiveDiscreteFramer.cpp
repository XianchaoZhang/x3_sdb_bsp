...
H264VideoLiveDiscreteFramer* H264VideoLiveDiscreteFramer::createNew(UsageEnvironment& env, FramedSource* inputSource)
{
	return new H264VideoLiveDiscreteFramer(env, inputSource);
}

H264VideoLiveDiscreteFramer::H264VideoLiveDiscreteFramer(UsageEnvironment& env, FramedSource* inputSource)
...
void H264VideoLiveDiscreteFramer::afterGettingFrame(void* clientData,
		unsigned frameSize,
