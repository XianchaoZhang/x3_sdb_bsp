...
int get_annexb_nalu(unsigned char *frame, int length, NALU_t *nalu)
{
	...
	int i = 0;
#if 0
	printf("frame data:%02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x len:%u\n",
	...
	if (info2 != 1)
	{
		...
		{
			LOGI_print("error frame data:%02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x %02x%02x%02x%02x len:%u",
			frame[i++], frame[i++], frame[i++], frame[i++],
			   frame[i++], frame[i++], frame[i++], frame[i++],
			   frame[i++], frame[i++], frame[i++], frame[i++],
			   frame[i++], frame[i++], frame[i++], frame[i++],
