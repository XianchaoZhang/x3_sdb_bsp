...
create_uvc()
{
    ...
    # Set the CT bmcontrols value 20A:support Exposure Time(Absoulut)/Roll
    echo 0x20A > functions/uvc.0/control/terminal/camera/default/bmControls
...
create_msd() {
    ...
    then
        ...
        mkfs.vfat $MSD_STORE > /dev/null 2>&1
        echo "OK"
    fi
