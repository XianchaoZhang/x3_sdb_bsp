...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.30.1/aarch64-linux',
    archname => 'aarch64-linux',
    cc => 'aarch64-hobot-linux-gcc  -mcpu=cortex-a53+crc -fstack-protector-strong  -D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -Werror=format-security ',
    d_readlink => 'define',
    d_symlink => 'define',
    dlext => 'so',
    dlsrc => 'dl_dlopen.xs',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/lib/perl5/site_perl/5.30.1/aarch64-linux',
