...
drand48_r_proto='0'
dtrace=''
dynamic_ext='Compress/Raw/Bzip2 Compress/Raw/Zlib DB_File Digest/MD5 Digest/SHA Encode Filter/Util/Call IPC/SysV Math/BigInt/FastCalc MIME/Base64 Scalar/List/Utils Socket Sys/Syslog Time/Piece Unicode/Collate Data/Dumper Devel/PPPort IO PathTools Storable threads threads/shared Time/HiRes Unicode/Normalize attributes B Devel/Peek Fcntl File/DosGlob File/Glob GDBM_File Hash/Util Hash/Util/FieldHash I18N/Langinfo mro NDBM_File Opcode PerlIO/encoding PerlIO/mmap PerlIO/scalar PerlIO/via POSIX re SDBM_File Sys/Hostname Tie/Hash/NamedCapture XS/APItest XS/Typemap'
eagain='EAGAIN'
ebcdic='undef'
echo='echo'
egrep='egrep'
