...
typedef int (*w1_slave_found_callback)(struct w1_master *, u64);
...
struct w1_master *w1_search_master_id(uint32_t id);
...
int w1_master_setup_slave(struct w1_master *dev, u8 fid, char*secret_buf, char*w_buf);
